...
namespace M220N.Repositories
{
    public class MoviesRepository
    {
            ...
            )
        {
            ...
            //   .Project(...)
            //   .ToListAsync(cancellationToken);
            var countriesFilter = Builders<Movie>.Filter.In("countries", countries);
            var projectFilter = Builders<Movie>.Projection.Include(m=>m.Title);

            return  await _moviesCollection
               .Find<Movie>(countriesFilter)
